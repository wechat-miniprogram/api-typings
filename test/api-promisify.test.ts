...
wx.checkIsSupportSoterAuthentication({
    success(res) {
        expectType<WechatMiniprogram.CheckIsSupportSoterAuthenticationSuccessCallbackResult>(res);
    },
});
wx.navigateBack({
    success(res) {
...
// call with await
async () => {
    expectType<WechatMiniprogram.ChooseImageSuccessCallbackResult>(await wx.chooseImage({}));
    expectType<WechatMiniprogram.CanvasToTempFilePathSuccessCallbackResult>(
        await wx.canvasToTempFilePath({ canvasId: '' }),
    );
    expectType<WechatMiniprogram.GeneralCallbackResult>(await wx.stopAccelerometer());
    expectType<WechatMiniprogram.GetClipboardDataSuccessCallbackOption>(await wx.getClipboardData());
    expectType<WechatMiniprogram.GeneralCallbackResult>(await wx.stopCompass());
    expectType<WechatMiniprogram.GeneralCallbackResult>(await wx.addPhoneContact({ firstName: '' }));
    expectType<WechatMiniprogram.GeneralCallbackResult>(await wx.startLocalServiceDiscovery({ serviceType: '' }));
    expectType<WechatMiniprogram.SystemInfo>(await wx.getSystemInfo());
    expectType<WechatMiniprogram.ChooseLocationSuccessCallbackResult>(await wx.chooseLocation({}));
    expectType<WechatMiniprogram.GeneralCallbackResult>(await wx.previewImage({ urls: [] }));
    expectType<WechatMiniprogram.GeneralCallbackResult>(await wx.saveVideoToPhotosAlbum({ filePath: '' }));
    expectType<WechatMiniprogram.GeneralCallbackResult>(await wx.removeSavedFile({ filePath: '' }));
    expectType<WechatMiniprogram.BluetoothError>(await wx.createBLEConnection({ deviceId: '' }));
    expectType<WechatMiniprogram.BluetoothError>(await wx.startBluetoothDevicesDiscovery({}));
    expectType<WechatMiniprogram.GeneralCallbackResult>(await wx.hideShareMenu());
    expectType<WechatMiniprogram.CheckIsSupportSoterAuthenticationSuccessCallbackResult>(
